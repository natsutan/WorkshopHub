...
def main():
    ...
    ur5 = scene.add_entity(
        # ここにURDFファイルのパスを指定
        gs.morphs.URDF(file='D:/home/myproj/genesis/pybullet_ur5_gripper/robots/urdf/ur5e_fixed.urdf'),
    #   gs.morphs.URDF(file='D:/home/myproj/genesis/Genesis/genesis/assets/urdf/kuka_iiwa/model.urdf'),
